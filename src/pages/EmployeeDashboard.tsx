...
const EmployeeDashboard = () => {
  ...
  const { items: cartItems, isLoading: cartLoading, periodStart, periodLabel, removeFromCart } = useCart();
          ...
          <Card className={`p-6 animate-slide-up ${!testStatus.burnout.completed ? 'opacity-60' : ''}`} style={{ animationDelay: "0.2s" }}>
            ...
            {testStatus.perception.completed ? (
              ...
              <div className="space-y-3">
                ...
                <Button className="w-full" variant="outline" onClick={() => navigate("/test/perception")}>
                  <RefreshCw className="mr-2 h-4 w-4" />
