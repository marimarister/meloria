            ...
            <div className="space-y-4 mb-8">
              ...
              <Card className="p-6">
                <div className="flex flex-col md:flex-row gap-6 md:items-center">
                  ...
                  <div className="w-full md:w-[30%] space-y-2">
                    <h3 className="text-2xl md:text-lg font-semibold">Emotional Exhaustion</h3>
              ...
              <Card className="p-6">
                <div className="flex flex-col md:flex-row gap-6 md:items-center">
                  {/* Title and Score */}
                  <div className="w-full md:w-[30%] space-y-2">
                    <h3 className="text-2xl md:text-lg font-semibold">Depersonalization</h3>
              ...
              <Card className="p-6">
                <div className="flex flex-col md:flex-row gap-6 md:items-center">
                  {/* Title and Score */}
                  <div className="w-full md:w-[30%] space-y-2">
                    <h3 className="text-2xl md:text-lg font-semibold">Personal Accomplishment</h3>
